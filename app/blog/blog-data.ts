    ...
    locales: {
      fa: {
        ...
        takeaways: [
          ...
          "برای ثبت‌نام در دورهمی‌ها یا دریافت مشاوره مستقیم، بخش [آموزش جامع وایب‌کدینگ](/vibe-coding/) و [صفحه تماس با حسن شاهمرادی](/contact?service=vibecoding) همراه شماست.",
        ],
      },
      en: {
