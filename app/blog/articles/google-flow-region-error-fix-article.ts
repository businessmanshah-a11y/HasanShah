      ...
      sections: [
        ...
        },
        {
          ...
          callout: {
            ...
            text: "همیشه یک اکانت جیمیل مستقل مخصوص کارهای هوش مصنوعی داشته باش و پروژه‌ها، پرامپت‌ها و کاراکترهای ساخته‌شده در گوگل فلو را در آن مدیریت کن. اگر قصد داری تصاویر ثابتت را به ویدیوهای تبلیغاتی تبدیل کنی، حتماً راهنمای [۱۰۰ پرامپت و دستور تبدیل عکس به ویدیو با هوش مصنوعی](/blog/ai-image-to-video-cinematic-prompts/) را بررسی کن تا با بهترین تکنیک‌های نورپردازی و افکت‌های سینمایی آشنا شوی.",
          },
          image: {
