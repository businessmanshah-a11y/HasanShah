...
export default function PortfolioContent() {
  ...
  return (
    ...
    >
      ...
      {/* Main container with generous clearance under fixed nav */}
      <main className="pt-36 sm:pt-40 md:pt-48 pb-32">
        {/* ── Breadcrumb ── */}
        ...
        <section className="container mx-auto px-4 mb-20 md:mb-28">
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            {/* Luminous Floating Metrics Strip (Airy, Non-Boxed, Breathing) */}
            <div className="max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 pt-2">
              <div className="rounded-2xl border border-white/10 bg-surface/30 backdrop-blur-sm p-4 text-center transition-all duration-300 hover:border-gold/30">
        ...
        {/* ── Filters & Search Controls (Floating Glass Bar, No Scrollbar) ── */}
        <section className="container mx-auto px-4 mb-20 md:mb-28">
          <div className="max-w-6xl mx-auto rounded-3xl border border-white/10 bg-surface/40 p-4 sm:p-5 backdrop-blur-md shadow-2xl">
        ...
        {liveProjects.length > 0 && (
          <section className="container mx-auto px-4 mb-24 md:mb-36">
            <div className="max-w-6xl mx-auto mb-10 sm:mb-12 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-5">
        ...
        {/* ── Section Transition Separator (Breaks monotony between Section 1 & Section 2) ── */}
        {liveProjects.length > 0 && customProjects.length > 0 && (
          <div className="container mx-auto px-4 my-20 md:my-28">
            <div className="max-w-6xl mx-auto relative flex items-center justify-center">
              ...
              <div className="absolute bg-background px-6 py-1.5 rounded-full border border-white/10 flex items-center gap-2 text-xs font-bold text-gold shadow-lg">
                <Cpu className="h-3.5 w-3.5 text-gold" />
                <span>
                  {locale === "fa"
                    ? "بخش دوم: سیستم‌های نرم‌افزاری و استارتاپ‌ها"
                    : locale === "ar"
                    ? "القسم الثاني: البرمجيات والأنظمة المخصصة"
        ...
        {/* ── Bridge Section: About Me Story (Editorial Strip - Non-Boxed to avoid CTA collision) ── */}
        <section className="container mx-auto px-4 my-24 md:my-36">
          <div className="max-w-6xl mx-auto rounded-[2.5rem] border border-white/10 bg-gradient-to-b from-surface/40 via-surface/20 to-transparent p-8 sm:p-12 md:p-14 relative overflow-hidden backdrop-blur-xl shadow-2xl">
        ...
        {/* ── Conversion Bottom CTA: Standalone High-Impact Hub ── */}
        <section className="container mx-auto px-4 mt-20 md:mt-28">
          <div className="max-w-5xl mx-auto relative overflow-hidden rounded-[2.5rem] border border-gold/40 bg-gradient-to-br from-surface via-surface/90 to-background p-8 sm:p-12 md:p-16 shadow-gold/20 text-center">
