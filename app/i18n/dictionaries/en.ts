...
const en: Dictionary = {
  ...
  portfolio: {
    ...
    viewAllCta: "Explore Full Portfolio Archive & Tech Specs",
    liveBadge: "Live & Active",
    visitLive: "Visit Live Website",
    openPrefix: "Open",
    fallbackCategory: "Project",
    projects: {
      "گالری فرش دهقانی": "Handmade and modern Persian carpet e-commerce with rich catalogs and SMS login",
      "کافه ایلا": "Interactive digital menu and brand showcase for specialty coffee house with instant QR access",
      "گیم لند": "High-volume gaming platform for Call of Duty CP and game top-ups with instant delivery",
      "اف‌زد پیرسینگ": "Modern hypoallergenic body piercing and jewelry shop with trendy aesthetics",
      "نداهیر": "Organic hair care center and shop directed by Neda Kefaayati with custom consultation",
      "زد‌ان‌زد پرفیوم": "Luxury perfume boutique featuring niche fragrances, olfactive filters and decants",
  ...
  consultationHighlight: {
    ...
    items: [
      { title: "It's free", desc: "No charge for the consultation session" },
      { title: "No commitment", desc: "We just map out your path — no contract required" },
      { title: "Quick & online", desc: "30-minute online session — from anywhere" },
    ],
  ...
  consultForm: {
    ...
    services: {
      website: { title: "Website Design" },
      app: { title: "App Development" },
      vibecoding: { title: "Vibe Coding Training" },
      startup: { title: "Startup Launch" },
    },
  ...
  latestArticles: {
    badge: "Tutorials & Hands-On Guides",
    title: "Latest *Guides & Articles*",
    desc: "Actionable playbooks, advanced prompt engineering methods, and vibe coding strategies for builders and founders.",
  ...
  blogArchive: {
    metaTitle: "Tutorials & Deep Dives",
    metaDesc: "Comprehensive guides on AI tools, vibe coding with Cursor & Claude, ChatGPT slash commands, and high-converting landing pages.",
    badge: "Specialized Hub for AI & Digital Handbooks",
    titlePlain: "Hands-on Tutorials &",
    titleAccent: "Deep Dives",
    desc: "Step-by-step, no-fluff guides to mastering modern AI workflows, vibe coding with Cursor, and building high-converting landing pages.",
    searchPlaceholder: "Search title, topic, or tool...",
    clearSearch: "Clear",
    featuredBadge: "Featured Master Guide",
    readFullArticle: "Read Full Article",
    otherArticlesHeading: "More Articles & Tutorials",
    searchResultsHeading: "Search Results",
    articlesCountSuffix: "articles",
    emptyTitle: "No articles matched your criteria",
    emptyDesc: "Try adjusting your search query or reset the category filter to 'All'.",
    emptyBtn: "View All Articles",
    ctaBadge: "Direct Consultation with Hasan",
    ctaTitle: "Want to build a high-converting website for your business?",
    ctaDesc: "In a free 30-minute session, we'll map out a clear path to turn visitors into loyal paying clients.",
  ...
  blogDetail: {
    ...
    takeawaysHeading: "Key Takeaways & Summary",
    tagsLabel: "Related Tags:",
    aboutAuthor: "About the Author",
    bookConsultation: "Book an online consultation with me",
    sidebarWidgetBadge: "Free 30-Min Consultation",
    sidebarWidgetTitle: "Want to launch a custom site for your brand?",
    sidebarWidgetDesc: "Luxury landing pages, vibe coding, and high-impact lead generation strategies for your business.",
    sidebarWidgetBtn: "Book Free Consultation",
    relatedHeading: "Recommended Reading",
    relatedSubtitle: "Related Guides & Articles",
    viewAll: "View All",
    readMore: "Read",
  },
};
