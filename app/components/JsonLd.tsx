...
export function VibeCodingEventJsonLd() {
  const schema = {
    ...
    url: `${BASE}/vibe-coding#workshop`,
    startDate: "2026-06-18T11:00:00+03:30",
    endDate: "2026-06-18T13:00:00+03:30",
    inLanguage: ["fa", "en", "ar"],
    ...
    offers: {
      ...
      availability: "https://schema.org/InStock",
      url: `${BASE}/vibe-coding#workshop`,
      validFrom: "2026-06-13T00:00:00+03:30",
    },
    location: {
      "@type": "Place",
      name: "مرکز نوآوری زی‌تک",
      alternateName: "Ztech Innovation Center",
      address: {
        "@type": "PostalAddress",
        streetAddress: "ساختمان رویش، واحد ۱۰۴",
